...
export function ContestSummaryCards({ summary, loading }: Props) {
  if (loading) {
    return (
  ...
  return (
    <div className="contest-summary-grid" role="region" aria-label="오늘의 공모전 현황 요약">
      <div className="contest-summary-card contest-summary-card--new">
      ...
      <div className="contest-summary-card contest-summary-card--deadline">
